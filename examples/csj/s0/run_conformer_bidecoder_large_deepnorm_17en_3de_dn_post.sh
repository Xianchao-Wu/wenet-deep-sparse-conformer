...
train_config=conf/train_conformer_bidecoder_large_17en_3de_deepnorm_postnorm.yaml
...
dir=exp/sp_spec_aug_conformer_bidecoder_large_deepnorm_17en_3de_dn_post # model's dir (output dir)
checkpoint=$dir/2.pt
